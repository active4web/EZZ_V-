...
class Statehome extends State<Home> with TickerProviderStateMixin {
  ...
  getdata1() async {
    ...
    Future.delayed(const Duration(milliseconds: 1), () async {
      ...
      await Provider.of<Notifires>(context, listen: false)
      ...
      if (type == "2") {
        try {
          return showDialog(
            ...
            context: context,
            builder: (context) {
              return StatefulBuilder(builder: (contexta, setState) {
                        ...
                        Container(
                            ...
                            child: Container(
                              child: Container(
                                ...
                                child: banner[0]["photos"].length == 0
                                    ? Container()
          ...
          if (homedata[i]["ID"].toString() == cat_id.toString()) {
            ...
            Navigator.of(context).push(MaterialPageRoute(builder: (context) {
              return Showpage(
                ...
                subcategories: homedata[i]["SubCategories"],
              );
            }));
          }
        }
  ...
  List data = [
    {"title": "بائعين جملة", "desc": "جميع أنواع بهيمة الانواع"},
    {"title": "بائعين الذبائح", "desc": "ذبيحتك لباب بيتك-بلدي ومستورد"},
    {
      "title": "اسر منتجة",
      "desc": "لأطعمة والحلويات وكافة ماتقوم بانتاجه الاسرة"
    },
    {
      "title": "الطهاة والمطابخ",
      "desc": "توصيل ذبيحتك مطبوخة أو اطلب طاهي الى منزلك"
    },
    ...
    {
      "title": "مزارع بيع الطيور",
      "desc": "الدجاج البلدي والحمام الفرنسي وغيرها"
    },
                                        ...
                                        child: Container(
                                            ...
                                            child: Image(
                                              image: AssetImage(
                                                  "images/logoaz.png"),
                                              fit: BoxFit.fill,
                                            ) //Text("الرئيسية",style: TextStyle(color: Colors.white,fontSize: MediaQuery.of(context).textScaleFactor * 13),)
                                            )),
                                    Expanded(
                                        flex: 3,
                                        child: InkWell(
                                            ...
                                            child: SvgPicture.asset(
                                              "svg/Icon-alarm.svg",
                                              semanticsLabel: "wadca",
                                            ))),
                                    Expanded(
                                        flex: 3,
                                        child: InkWell(
                                            onTap: () => navigatetoshopping(),
                                            child: Container(
                                                child: SvgPicture.asset(
                                              "svg/Icon feather-shopping-cart.svg",
                                              semanticsLabel: "wasdca",
                                            )))),
                                    Expanded(
                                        flex: 3,
                                        child: InkWell(
                                            onTap: () => navigatetolocation(),
                                            child: Icon(
                                              Icons.settings,
                                              color: Colors.white,
                                            ))),
                ...
                child: ads.length == 0
                    ...
                    : CarouselSlider.builder(
                        ...
                        itemBuilder: (context, index, real) {
                          ...
                          print(ads[index]["Photo"].toString().substring(
                              ads[index]["Photo"].toString().length - 3,
                              ads[index]["Photo"].toString().length));
                          return Container(
                              width: MediaQuery.of(context).size.width,
                              height: MediaQuery.of(context).size.height,
                              child: ads[index]["Photo"].toString().substring(
                                          ads[index]["Photo"]
                                                  .toString()
                                                  .length -
                                              3,
                                  ...
                                  : Image(
                                      fit: BoxFit.fill,
                                      image: NetworkImage(ads[index]["Photo"]),
                                    ));
                        },
                          ...
                          : query.text == "" || !searchable
                              ? GridView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    return InkWell(
                                      onTap: () => showtoshowpage(
                                          i,
                                          homedata[i]["Name"],
                                          homedata[i]["SubCategories"]),
                                      child: Container(
                                        width:
                                            MediaQuery.of(context).size.width,
                                        height:
                                          ...
                                          children: [
                                            ...
                                            Container(
                                                ...
                                                child: Center(
                                                  ...
                                                  child: AutoSizeText(
                                                    homedata[i][
                                                        "Name"], //,maxFontSize: MediaQuery.of(context).textScaleFactor*9,minFontSize:MediaQuery.of(context).textScaleFactor*9,
                                                    style: TextStyle(
              ...
              child: true
                  ...
                  : Container(
                      ...
                      child: GridView.builder(
                        ...
                        itemCount: homedata[9]["SubCategories"].length,
                        itemBuilder: (context, i) {
                          return Container(
                            margin: EdgeInsets.all(
                            ...
                            child: InkWell(
                                onTap: () =>
                                    null //showtoshowpage(i,homedata[i]["Name"] , homedata[i]["SubCategories"]),
                                ,
                                child: Container(
                                  width: MediaQuery.of(context).size.width,
                                  height: MediaQuery.of(context).size.height,
                                  ...
                                  child: Column(
                                    children: [
                                      Container(
                                        ...
                                        child: Image(
                                          fit: BoxFit.fill,
                                          image: NetworkImage(homedata[9]
                                              ["SubCategories"][i]["Photo"]),
                                        ),
                                      ),
                                      Container(
                                          height: MediaQuery.of(context)
                                                ...
                                                Expanded(
                                                  ...
                                                  child:
                                                      fav[i]["UserFav"]
                                                          ...
                                                          : InkWell(
                                                              onTap: () =>
                                                                  null //showpagelogic.addtofav(fa[i]["ID"],id,subcategories,context),
                                                              ,
                                                              child: Container(
                                                                width: MediaQuery.of(
                                                                            context)
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              alignment: Alignment.centerRight,
                              child: AutoSizeText(
                                profiledata.toString() == "null"
                                    ? ""
                                    : profiledata["Name"].toString(),
                                maxLines: 1,
                                style: TextStyle(
                                    color: Color.fromRGBO(11, 12, 58, 1),
                                    fontWeight: FontWeight.bold,
                                    fontSize:
                                        MediaQuery.of(context).textScaleFactor *
                                            17),
          ...
          InkWell(
            onTap: () {
              Provider.of<Notifires>(context, listen: false)
                  .getindex(tabController, "req", 2, context);
            ...
            child: Container(
              ...
              child: ListTile(
                ...
                leading: Container(
                  ...
                  height: MediaQuery.of(context).size.width * 0.11,
                  child: Image(
                      fit: BoxFit.fill, image: AssetImage("images/more2.png")),
                ),
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: ListTile(
                ...
                leading: Container(
                  ...
                  height: MediaQuery.of(context).size.width * 0.11,
                  child: Image(
                      fit: BoxFit.fill, image: AssetImage("images/more7.png")),
                ),
              ),
            ),
          ),
