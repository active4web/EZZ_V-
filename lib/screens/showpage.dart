...
class Showpage extends StatefulWidget {
  ...
  var cat;
  Showpage(
      {this.id, this.name, this.subcategories, this.cat, this.tabcontroller});
  @override
...
class Stateshowpage extends State<Showpage>
                            ...
                            return InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(10),
                                    color:
                                        Colors.white //,boxShadow: [BoxShadow(
                                    //   color: Colors.black26,
                                    //  blurRadius: 1.0,
                                    //  spreadRadius: 0.0,
                                                                ...
                                                                child: providers[i]["BestSeller"]
                                                                    ...
                                                                    ? InkWell(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              borderRadius: BorderRadius.circular(10),
                                                                              color: Color.fromRGBO(254, 254, 115, 1)),
                                                                          child: FittedBox(
                                                                              child: Row(children: [
                                                                            Text(
                                                                              "بائع مميز",
                                                                            ...
                                                                            Container(
                                                                                ...
                                                                                child: Image(image: AssetImage("images/like.jpg"), fit: BoxFit.fill)),
                                                                          ])),
                                                                        ),
                                                                      )
                                                                    : Container()))
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Expanded(
                                                            flex: 2,
                                                            child: Container(
                                                                child: searchresult[i]["BestSeller"]
                                                                            .toString() ==
                                                                        "1"
                                                                    ? InkWell(
                                                                        onTap: () =>
                              ...
                              child: Container(
                                  ...
                                  child: false
                                      ...
                                      : Container(
                                          child: InkWell(
                                            onTap: () async {
                                              await Provider.of<Notifires>(
                                                      context,
                                                      listen: false)
                                                  .getindex(tabController,
                                                      "more", 3, context);
                                              await Provider.of<Notifires>(
                                                      context,
                                                      listen: false)
  ...
  getdata(index) async {
    ...
    Future.delayed(const Duration(milliseconds: 500), () {
      Provider.of<Notifires>(context, listen: false)
          .getdatashowpage(index, subcategories, context);
    });
  }
  ...
  showdetail(i, search) {
    ...
    if (name == "اماكن") {
      ...
      if (cat == "مراسيل") {
        if (search) {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) {
            return Marasildetail1(
              detaildata: searchresult[i],
            );
          }));
        } else {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) {
            return Marasildetail1(
              detaildata: providers[i],
            );
          }));
        }
      } else {
